		...
		if (isset($_GET['do'])){
			if ($_GET['idprop'] !=""){
				...
				if ($_GET['do']=="4"){
					...
					//	echo "update tb_ptg_propiedades set tcm_id_i=".$_POST['tcm'].", tpr_id_i=".$_POST['tprop'].", zon_id_i=".$_POST['zona'].", est_id_i=".$locestado.", pro_descripcion_corta_s='".$_POST['descripcioncorta']."', pro_descripcion_extendida_s='".$_POST['descripcionlarga']."', pro_cant_ambientes_i=".$_POST['ambientes'].", pro_cantidad_metros_i=".$_POST['cantidadmetros'].", pro_hubicacion_s='".$_POST['ubicacion']."', pro_domicilio_real_s='".$_POST['domicilioreal']."', pro_precio_venta_i=".$_POST['precioventa'].", pro_precio_visible_b=".$locmostrarprecio.$imagenxdefecto.", pro_destacada_b=".$locdestacada.", pro_texto_destacada_s='".$_POST['textodestacada']."' where pro_id_i = ".$_GET['idprop'];
						
						$mensaje="<p align='center'><font color='#006600'><b>La propiedad se ha modificado correctamente.</b></font></p>";
				}
					//fin prop por defecto -----------------------------
				...
				} // FIN SELECT DE PROPIEDADES
					
			} //*************  FIN TIENE IDPROP = $_GET['idprop']
		}
		//*************  FIN EXISTE $_GET['do']
		  ...
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
			  <td width="254" valign="top"><table width="75%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
				  <td><div align="right"><a href="adminimagenes.php">Imagenes</a></div></td>
				</tr>
				<tr>
			   ...
			   ?>
				...
				<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
				  ...
				  <tr>
					...
					<form action="adminprop.php?do=8" method="post" enctype="multipart/form-data" name="Imagenes" id="Imagenes" onsubmit="MM_validateForm('newimagen','','R');return document.MM_returnValue">
					<img src="../images/edit_add.png" alt="Agregar Zona" width="20" height="20" border="0" align="absmiddle" />Agregar nueva Imagen:<br />
					  <div align="left">
						<input name="newimagen" type="file" id="newimagen" size="20" />
						<br />
					  </div>
					  <label>
					  <div align="left">
						Descripción:
						  <input name="descripcionimagen2" type="text" id="descripcionimagen2" size="20" maxlength="150" />
						<br />
						Orden:
						<input name="ordenimagen2" type="text" id="ordenimagen2" size="2" maxlength="2" />
					  </div>
					  </label>
					  <div align="left"><br />
					  </div>
				...
				?>
					<form name="img<?php echo $propimgs['idimagen'];?>" id="img<?php echo $propimgs['idimagen'];?>" method="post" action="adminprop.php?do=9">
					<input type="hidden" name="idimg" id="idimg" value="<?php echo $propimgs['idimagen'];?>" />
					<table width="100%" border="0">
					<tr>
					<td>
					<?php 
					echo "<a href='../images/prop/gran/".$propimgs['ruta'].".jpg' rel='lightbox[".$_GET['idprop']."]' title='".$propimgs['descripcionimagen']."'><img align='absmiddle' src='../images/prop/mini/".$propimgs['ruta'].".jpg' alt='".$propimgs['descripcionimagen']."' border='0' hspace='2' vspace='1' /></a>";
					?><br />
				   ...
				   <br />
					Orden: <input name="ordenimagen" type="text" id="ordenimagen" value="<?php echo $propimgs['orden']; ?>" size="1" maxlength="2" />
					<br />
					<input type="submit" name="guardarimg" id="guardarimg" value="Guardar Imagen" /></td>
					<td width="25"><a href="adminprop.php?do=10&amp;idprop=<?php echo $propimgs['idprop']; ?>" onclick="return confirmar('¿Está seguro que desea eliminar la imagen <?php echo $propimgs['ruta'].".jpg "; ?>?');"><img src="../images/edit_remove.png" alt="Eliminar Imagen <?php echo $propimgs['ruta'].".jpg "; ?>" width="20" height="20" hspace="5" border="0" /></a></td>
				  </tr>
				  </table>
					<p>&nbsp;</p>
				  </form>
			  ...
			  <td width="647" valign="top"><form action="adminprop.php?do=4&idprop=<?php echo $_GET['idprop']; ?>" method="post" enctype="multipart/form-data" name="propiedades" id="propiedades">
					  ...
					  <div align="center">
						...
						if ($_GET['do']=="2"){
							echo "<input type='submit' name='enviaform' id='enviaform' value='Editar Propiedad' />";
								...
								echo "<input type='submit' name='enviaform' id='enviaform' value='Grabar nuevo Propiedad' />";
							}
						?>
					  </div></td>
				  </tr>
			   ...
			   ?>
				<br />
		<form action="adminprop.php?do=5" method="post" name="detallespropiedades" id="detallespropiedades" onsubmit="MM_validateForm('descripciondetalle','','R');return document.MM_returnValue">
					  <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
						<tr>
						...
						<tr>
						  ...
						  <?php 
							...
							echo ' <select name="grupotipodetalle" id="grupotipodetalle">';
						...
						<tr>
						  ...
						  <td width="26">&nbsp;</td>
						  <td><input name="descripciondetalle" type="text" id="descripciondetalle" value="<?php echo utf8_encode($editdetalle['detalle']); ?>" size="20" maxlength="100" /></td>
						</tr>
						<tr>
						  <td width="193">&nbsp;</td>
						  <td width="26">&nbsp;</td>
			  ...
			  <td width="334" valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
				  ...
				  <td width="20"><a href="adminprop.php?do=3&idprop=<?php echo $listprop['idprop']; ?>" onclick="return confirmar('¿Está seguro que desea eliminar la propiedad <?php echo "(".$listprop['idprop'].") ".$listprop['ubicacion']; ?>?');"><img src="../images/edit_remove.png" alt="Eliminar Propiedad <?php echo $listprop['ubicacion']; ?>" width="20" height="20" hspace="5" border="0" /></a></td>
				</tr>
				<?php
				}
				?>
